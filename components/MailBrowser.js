    ...
    <div className={styles.browser} onClick={(e) => e.stopPropagation()}>
      <div className={styles.toolbar}>
        <div className={styles.tabBar}>
          <div className={styles.tab}>
            ...
            <span className={styles.tabTitle}>Mail - csiddharth380@gmail.com</span>
      ...
      <div className={styles.addressBar}>
        ...
        <div className={styles.urlBar}>
          ...
          <span className={styles.urlText}>mailto:csiddharth380@gmail.com</span>
        </div>
        ...
        {isLoading ? (
          ...
          <div className={styles.externalSitePrompt}>
            ...
            <p className={styles.externalSiteDescription}>
              Click the button below to open your default email client and send an email to csiddharth380@gmail.com
            </p>
            <a
              href="mailto:csiddharth380@gmail.com"
              target="_blank"
